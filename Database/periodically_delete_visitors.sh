...
echo "$(timestamp): Start deleting visitors" >> /home/ubuntu/git/SE-Projekt/my-app-backend/src/build/result.txt
...
echo "$result" >> /home/ubuntu/git/SE-Projekt/my-app-backend/src/build/result.txt
echo "--------------------------------------" >> /home/ubuntu/git/SE-Projekt/my-app-backend/src/build/result.txt
